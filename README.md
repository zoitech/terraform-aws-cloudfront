...
| <a name="input_tags"></a> [tags](#input\_tags) | Tags to be added to the distribution | `map(string)` | `{}` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_cf_arn"></a> [cf\_arn](#output\_cf\_arn) | n/a |
| <a name="output_cf_id"></a> [cf\_id](#output\_cf\_id) | n/a |
